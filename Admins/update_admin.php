                ...
                <div class="oneuser">
                    <div class="allinput">
                        <div class="input-filed">
                            ...
                            <input type="text" value="<?php echo $old_data_admin['Full_Name'] ?>" placeholder="يرجي كتابه الاسم باللغه العربيه كاملا" name="full-name" id="name" required>
                        </div>
                        ...
                        <div class="input-filed">
                            ...
                            <input type="text" value="<?php echo $old_data_admin['Address'] ?>" id="address" name="address">
                        </div>
                        <div class="input-filed">
                            <label for="id">الرقم القومي</label>
                            <input type="number" value="<?php echo $old_data_admin['Ad_ID'] ?>" placeholder="يرجي كتابه الرقم القومي بشكل صحيح " id="id" name="id" required>
                        </div>
                        <div class="input-filed">
                            <label for="phone">رقم المحمول</label>
                            <input type="number" value="<?php echo $old_data_admin['Phone_Number'] ?>" placeholder="+20**********" id="phone" name="phone">
                        </div>
                        <div class="input-filed">
                            <label for="faculty"> الكلية</label>
                            <input type="text" value="<?php echo $old_data_admin['Faculty'] ?>" placeholder id="faculty" name="faculty">
                        </div>
                        <div class="input-filed">
                            <label for="university"> الجامعة</label>
                            <input type="text" value="<?php echo $old_data_admin['University'] ?>" placeholder id="university" name="university">
                        </div>
                        <div class="input-filed">
                            <label for="job"> الوظيفة</label>
                            <input type="text" value="<?php echo $old_data_admin['Job'] ?>" placeholder id="job" name="job">
                        </div>
                        <div class="input-filed">
                            <label for="email"> البريد الالكتروني</label>
                            <input type="email" value="<?php echo $old_data_admin['Email_Address'] ?>" id="email" name="email" required>
                        </div>
                        <div class="input-filed">
                            <label for="password"> الرقم السري</label>
                            <input type="password" value="<?php echo $old_data_admin['Password'] ?>" id="password" name="password" required>
                        </div>
                        <div class="input-filed">
                            <label for="gender">النوع</label>
                            <div class="gender">
                                <div class="male">
                                    <input type="radio" name="type" id="male" value="ذكر" <?php echo $old_data_admin['Gender'] == "ذكر" ? 'checked' : '' ?>>
                                    <label for="male">ذكر</label>
                                </div>
                                <div class="female">
                                    <input type="radio" name="type" id="female" value="انثي" <?php echo $old_data_admin['Gender'] == "انثي" ? 'checked' : '' ?>>
