                    ...
                    <div class="oneuser">
                        ...
                        <div class="allinput">
                            <div class="input-filed">
                                ...
                                <input type="text" value="<?= $old_data_student['Full_Name'] ?>"
                                    placeholder="يرجي اضافه الاسم كامل باللغه العربيه" id="name" name="full-name"
                                    required>
                            </div>
                            <div class="input-filed">
                                <label for="password">الباسورد</label>
                                <input type="text" value="<?= $old_data_student['Password'] ?>" id="password"
                            ...
                            <div class="input-filed">
                                ...
                                <input type="text" id="nationality" name="nationality"
                                    value="<?= $old_data_student['Nationality'] ?>">
                            </div>
                            <div class="input-filed">
